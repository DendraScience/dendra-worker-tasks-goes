...
module.exports = {
  guard(m) {
    return !m.ddsConnectError && m.private.ddsClient && !m.private.ddsClient.isConnected && m.private.stan && m.stanConnected;
  },
  ...
  execute(m, { logger }) {
    ...
    logger.info('DDS client connecting', { host: client.options.host, port: client.options.port });
